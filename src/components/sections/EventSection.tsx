            ...
            >
              <div className="p-6 lg:p-8">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  >
                    {event.type === 'akad' ? 'Akad' : 'Ngunduh Mantu'}
                  </div>
                </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="shrink-0 text-center">
                        ...
                        <div className="text-xs font-wedding-body uppercase tracking-wide" style={{color: '#8B6914'}}>
                          {event.date.toLocaleDateString('id-ID', { month: 'short' })}
                        </div>
                      </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm lg:text-base font-wedding-body font-semibold" style={{color: '#311212'}}>
                            {event.date.toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
                          </span>
                        </div>
                ...
                <div className="pt-4 border-t" style={{borderColor: '#E5D5C5'}}>
                  ...
                  <CompactCountdown eventDate={event.date} />
                </div>
              </div>
            </div>
          ))}
